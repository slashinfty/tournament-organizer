...
export class Tournament {
    ...
    set(options) {
        ...
        if (options.hasOwnProperty('seating'))
            this.seatings = options.seating;
        if (options.hasOwnProperty('sorting'))
            this.sorting = options.sorting;
        if (options.hasOwnProperty('scoring'))
            Object.assign(this.scoring, options.scoring);
        if (options.hasOwnProperty('stageOne'))
            Object.assign(this.stageOne, options.stageOne);
        if (options.hasOwnProperty('stageTwo'))
            Object.assign(this.stageTwo, options.stageTwo);
