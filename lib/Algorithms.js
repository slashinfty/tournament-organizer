...
const Algorithms = {
     ...
     */
    pairCompare: (p1, p2) => {
        console.log('p1: ' + p1.alias + ' pref: ' + p1.colorPref + ' colors: ' + JSON.stringify(p1.colors));
        console.log('p2: ' + p2.alias + ' pref: ' + p2.colorPref + ' colors: ' + JSON.stringify(p2.colors));
    ...
    dutch: (players, round, maxPoints) => {
        ...
        const pairAttempt = p => {
            ...
            do {
                ...
                console.log('s1: ' + s1.map(p => p.alias));
                console.log('s2: ' + s2.map(p => p.alias));
