...
const Algorithms = {
     ...
     */
    elim: (matches, players, thirdPlace) => {
        ...
        // Assign players.
        matches.filter(r => r.round === 1 + (rem !== 0)).forEach((m, i) => {
        ...
        if (rem !== 0) {
            const winnerRound1 = matches.filter(p => p.round === 1);
            winnerRound1.forEach((m, i) => {
                m.playerOne = players[2 ** Math.floor(mod) + i];
                const playerTwo = players[2 ** Math.floor(mod) - i - 1];
                const n = matches.filter(p => p.round === 2).find(m => (m.playerOne !== null && m.playerOne.id === playerTwo.id) || (m.playerTwo !== null && m.playerTwo.id === playerTwo.id));
    ...
    doubleElim: (matches, players) => {
        ...
        if (rem !== 0) {
            const r1 = matches.filter(p => p.round === 1);
            const r2 = matches.filter(p => p.round === 2);
            let i = 0;
            let j = 0;
            r2.forEach(x => {
                for (let z = 0; z < 2; z++) {
        ...
        const less = matches.filter(m => m.round === 2 && (m.playerOne === null || m.playerTwo === null)).map(m => Math.ceil(m.matchNumber / 2));
        const great = matches.filter(m => m.round === 2 && m.playerOne === null && m.playerTwo === null).map(m => m.matchNumber);
            ...
            do {
                ...
                if (thesePlayers.length === 0) {
                    ...
                    if (p === 0 && hold.length > 0) {
                        ...
                        newMatches.push(new Match(newId, round, matchNumber, [hold[0], null]));
                        return true;
                ...
                while (hold.length > 0) {
                    ...
                    if (hold[0].results.findIndex(o => o.opponent.id === thesePlayers[l].id) === -1) {
                        let newId;
                        do {
                            newId = Utilities.randomString(12);
                        } while (matches.findIndex(m => m.id === newId) > -1 || newMatches.findIndex(m => m.id === newId) > -1);
                ...
                while (thesePlayers.length > 1) {
                    ...
                    while (i < thesePlayers.length) {
                        ...
                        if (thesePlayers[0].results.findIndex(o => o.opponent.id === thesePlayers[i].id) === -1) {
                            let newId;
                            do {
                                newId = Utilities.randomString(12);
                            } while (matches.findIndex(m => m.id === newId) > -1 || newMatches.findIndex(m => m.id === newId) > -1);
                ...
                if (thesePlayers.length === 1) {
                    ...
                    if (p === 0) {
                        ...
                        newMatches.push(new Match(newId, round, matchNumber, [thesePlayers[0], null]));
                        return true;
            ...
            do {
                ...
                while (s1.length + s2.length > 1) {
                    ...
                    while (i < s2.length) {
                        ...
                        if (s1[0].results.findIndex(o => o.opponent.id === s2[i].id) > -1 || (s1[0].colorPref === 2 && s2[i].colorPref === 2) || (s1[0].colorPref === -2 && s2[i].colorPref === -2)) i++;
                        else {
                ...
                if (s1.length === 1) {
                    if (p === 0) {
                        ...
                        newMatches.push(new Match(newId, round, matchNumber, [s1[0], null]));
                        return true;
                    } else hold.push(s1[0]);
                } else if (s2.length === 1) {
                    if (p === 0) {
                        ...
                        newMatches.push(new Match(newId, round, matchNumber, [s2[0], null]));
                        return true;
                    } else hold.push(s2[0]);
